...
void ProgramManager::schedule()
{
    ...
    printf_warning("Current Running is...");
    printInfo();
    interruptManager.setInterruptStatus(status);
}
...
{
    if(Message)
        printf_warning("[TangZh] Pid: %d Name: \"%s\" Piority: %d time: %dMessage: \"%s\"\n", running->pid, running->name, running->priority,running->ticksPassedBy,Message);
    else
        printf_warning("[TangZh] Pid: %d Name: \"%s\" Piority: %d time: %d\n", running->pid, running->name, running->priority,running->ticksPassedBy);
