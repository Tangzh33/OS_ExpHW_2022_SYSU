...
extern "C" void c_time_interrupt_handler()
{
    ...
    /* 滚屏实现 */
    // if (times < 25)
    //     stdio.moveCursor((times - 1) * 80);
    // else
    //     stdio.moveCursor(24 * 80);
    ...
    int idx = times % 15;
    int pos = stdio.getCursor() + idx + 3;
    stdio.moveCursor(pos);
    stdio.print(name[idx], idx % 10 + 2);
}