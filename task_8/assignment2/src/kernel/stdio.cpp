...
int printf_add_to_buffer(char *buffer, char c, int &idx, const int BUF_LEN, int color = 0x07)
{
    ...
    {
        buffer[idx] = '\0';
        counter = stdio.print(buffer,color);
        idx = 0;
    }
    ...
    for (int i = 0; fmt[i]; ++i)
    {
        ...
        else
        {
            ...
            case 's':
                buffer[idx] = '\0';
                idx = 0;
                counter += stdio.print(buffer, 0x07);
                counter += stdio.print(va_arg(ap, const char *), 0x07);
                break;
            ...
            case 'f':
                ...
                idx = 0;
                counter += stdio.print(buffer, 0x07);
                counter += stdio.print(to_string, 0x07);
                break;
            }
        }
    }
    ...
    for (int i = 0; fmt[i]; ++i)
    {
        ...
        else
        {
            ...
            case 's':
                buffer[idx] = '\0';
                idx = 0;
                counter += stdio.print(buffer, 0x03);
                counter += stdio.print(va_arg(ap, const char *), 0x03);
                break;
            ...
            case 'f':
                ...
                idx = 0;
                counter += stdio.print(buffer, 0x03);
                counter += stdio.print(to_string, 0x03);
                break;
            }
        }
    }
    ...
    for (int i = 0; fmt[i]; ++i)
    {
        ...
        else
        {
            ...
            case 's':
                buffer[idx] = '\0';
                idx = 0;
                counter += stdio.print(buffer, 0x47);
                counter += stdio.print(va_arg(ap, const char *), 0x47);
                break;
            ...
            case 'f':
                ...
                idx = 0;
                counter += stdio.print(buffer, 0x47);
                counter += stdio.print(to_string, 0x47);
                break;
            }
        }
    }
